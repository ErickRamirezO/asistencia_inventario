...
function DialogContent({
  ...
  // Calcular el offset basado en el estado del sidebar
  const getPositionClasses = () => {
    ...
    if (state === "collapsed") {
      // Sidebar colapsado - menos offset
      return "md:left-[calc(50%+1.5rem)] md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2";
    } else {
      // Sidebar expandido - más offset
      return "md:left-[calc(50%+8rem)] md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2";
    }
  };
