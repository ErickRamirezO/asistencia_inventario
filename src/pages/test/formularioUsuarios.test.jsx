...
describe("FormularioUsuario Component", () => {
  ...
  it("Registro exitoso de usuario", async () => {
    ...
    await user.click(
      screen.getByRole("button", { name: /Registrar Tarjeta RFID/i })
    );
    ...
    await user.click(
      screen.getByRole("button", { name: /Registrar Usuario/i })
    );
  });
  ...
  it("Validación cuando faltan campos obligatorios", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText("Los nombres deben tener al menos 2 caracteres.")
      ).toBeInTheDocument();
      expect(
        screen.getByText("Los apellidos deben tener al menos 2 caracteres.")
      ).toBeInTheDocument();
      expect(
